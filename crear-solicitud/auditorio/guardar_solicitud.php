...
function insertarSolicitudDeReserva(
        $auditorio, $fecha, $horaInicio, $horaFin, $responsable, 
    ...
    $obtener_id_ambiente = "select id_ambiente from auditorio where NOMBRE_AUDITORIO = '$auditorio'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $auditorio = Validador::desinfectarEntrada($entrada['auditorio']);
