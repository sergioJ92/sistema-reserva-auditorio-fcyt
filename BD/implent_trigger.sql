...
create table LOG (
   ...
   DATO_ANTIGUO         TEXT                 null,
   COD_ACCION           TEXT                 null,
   CODIGO_USR              TEXT                 null,
...
CREATE OR REPLACE FUNCTION log_bitacora_reserva()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_reserva
  ...
  ON reserva
  FOR EACH ROW
  EXECUTE PROCEDURE log_bitacora_reserva();


CREATE OR REPLACE FUNCTION log_bitacora_usuario()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'usuario', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'usuario', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'usuario', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_usuario
  ...
  ON usuario
  FOR EACH ROW
  EXECUTE PROCEDURE log_bitacora_usuario();


CREATE OR REPLACE FUNCTION log_bitacora_tiene_privilegio()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_privilegio', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_privilegio', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_privilegio', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_tiene_privilegio
  AFTER INSERT OR UPDATE OR DELETE
  ON TIENE_PRIVILEGIO
  FOR EACH ROW
  EXECUTE PROCEDURE log_bitacora_tiene_privilegio();


CREATE OR REPLACE FUNCTION log_bitacora_tiene_rol()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_rol', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_rol', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_rol', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_tiene_rol
  AFTER INSERT OR UPDATE OR DELETE
  ON TIENE_ROL
  FOR EACH ROW
  EXECUTE PROCEDURE log_bitacora_tiene_rol();



CREATE OR REPLACE FUNCTION log_bitacora_tiene_materia()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_materia', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_materia', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'tiene_materia', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_tiene_materia
  AFTER INSERT OR UPDATE OR DELETE
  ON TIENE_MATERIA
  FOR EACH ROW
  EXECUTE PROCEDURE log_bitacora_tiene_materia();


CREATE OR REPLACE FUNCTION log_bitacora_rol()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'rol', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'rol', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'rol', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
ON ROL
FOR EACH ROW
EXECUTE PROCEDURE log_bitacora_rol();


CREATE OR REPLACE FUNCTION log_bitacora_reserva_academica()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva_academica', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva_academica', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva_academica', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_reserva_academica
AFTER INSERT OR UPDATE OR DELETE
ON reserva_academica
FOR EACH ROW
EXECUTE PROCEDURE log_bitacora_reserva_academica();



CREATE OR REPLACE FUNCTION log_bitacora_reserva_solicitada()
  RETURNS trigger AS
$BODY$
BEGIN
IF(TG_OP = 'DELETE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr)VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva_solicitada', NULL, OLD, 'eliminar', (select current_user));
    RETURN OLD;
ELSIF (TG_OP = 'INSERT') THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva_solicitada', NEW, NULL, 'insertar', (select current_user));
    RETURN NEW;
ELSIF(TG_OP = 'UPDATE')THEN
    INSERT INTO log (fecha, hora, tabla, dato_nuevo, dato_antiguo, cod_accion,codigo_usr) VALUES(CURRENT_DATE, CURRENT_TIME, 'reserva_solicitada', NEW, OLD, 'actualizar', (select current_user));
    RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER bitacora_reserva_solicitada
AFTER INSERT OR UPDATE OR DELETE
ON reserva_solicitada
FOR EACH ROW
EXECUTE PROCEDURE log_bitacora_reserva_solicitada();
