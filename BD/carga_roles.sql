...
INSERT INTO usuario (nombre_usuario, contrasenia, nombres, apellidos, activo) VALUES
('root', '$2y$10$L1akpmxVFSI7/1/cwToZvegUJyrtYjAXsgAkUgMwTsaP5YppYnNxe', 'Evelyn', 'Cusi Lopez', TRUE);

INSERT INTO correo_usuario (nombre_usuario, correo) VALUES
('root', 'cusi.evelyn@gmail.com');

INSERT INTO TIENE_ROL(nombre_usuario, nombre_rol) VALUES('root', 'Super usuario');
